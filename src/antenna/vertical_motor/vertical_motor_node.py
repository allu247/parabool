...
rospy.init_node('vertical_motor_controller')
...
class RotationService:
    ...
    def __init__(self, port, slave):
        ...
        self.motor_rpm = 935
        self.transmission_constant = 3281,15
    ...
    def listener(self):
        rospy.Subscriber("vertical_motor_commands", String, self.callback)
        rospy.Subscriber("vertical_sensors", String, self.update_current_pos)
        rospy.spin()
