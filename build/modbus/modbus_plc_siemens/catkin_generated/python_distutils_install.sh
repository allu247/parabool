...
echo_and_run cd "/home/test/Projects/parabol-controller/src/modbus/modbus_plc_siemens"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/test/Projects/parabol-controller/src/modbus/modbus_plc_siemens/setup.py" \
    build --build-base "/home/test/Projects/parabol-controller/build/modbus/modbus_plc_siemens" \
    install \
    $DESTDIR_ARG \
