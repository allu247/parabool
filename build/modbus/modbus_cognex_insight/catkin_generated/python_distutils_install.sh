...
echo_and_run cd "/home/test/Projects/parabol-controller/src/modbus/modbus_cognex_insight"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/test/Projects/parabol-controller/src/modbus/modbus_cognex_insight/setup.py" \
    build --build-base "/home/test/Projects/parabol-controller/build/modbus/modbus_cognex_insight" \
    install \
    $DESTDIR_ARG \
